		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "InputValueHelp Demo ",
									"targetURL": "#InputValueHelpDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InputValueHelpDemo-display": {
								"semanticObject": "InputValueHelpDemo",
								"action": "display",
								"description": "Demo Application for Input Value Help Control.",
								"title": "InputValueHelp Demo ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=inputvaluehelp.demo",
									"url": sap.ui.require.toUrl("inputvaluehelp/demo")
								}
							}
						}
					}
